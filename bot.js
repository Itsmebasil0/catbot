...
const {Message, StringSession, Image, Video} = require('./SHA-MOWLE/');
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('✅ SHA-MOWLE working!')
        );
        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*SHA-MOWLE ᴡᴏʀᴋɪɴɢ*', MessageType.text);
                }
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*SHA-MOWLE_[error]*' +
                                    '\n\n*🍂 ' + error + '*\n' 
                                    , MessageType.text);
                            }
                        }
